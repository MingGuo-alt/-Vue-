  ...
  <div>
    ...
    <el-card style="margin-top: 10px">
      ...
      <el-table :data="userlist" border stripe class="user_message_table">
        ...
        <el-table-column label="贷款金额" prop="loan_amount"> </el-table-column>
        <el-table-column label="服务费" prop="service_fee_number"> </el-table-column>
        <el-table-column label="服务费收取" prop="service_fee_status"> </el-table-column>
