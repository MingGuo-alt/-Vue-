  ...
  <div>
    ...
    <el-card style="margin-top: 10px">
      ...
      <el-table :data="userlist" border stripe class="user_message_table">
        ...
        <el-table-column label="服务已收取" prop="service_fee_status">
        </el-table-column>
        ...
        <el-table-column label="操作">
          ...
          <template slot-scope="scope">
            ...
            <el-button
              ...
              size="mini"
              @click="UpdateFeeById(scope.row.id)"
            ></el-button>
          </template>
    ...
    >
      ...
      >
        <el-form-item label="服务费" prop="fee">
          <el-input v-model="addFormFee.fee"></el-input>
        </el-form-item>
        <el-form-item label="订单状态" prop="check_status">
          <el-input v-model="addFormFee.check_status"></el-input>
        </el-form-item>
      </el-form>
      <!-- 底部区域 -->
      <span slot="footer" class="dialog-footer">
        <el-button @click="addDialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="updateFee">确 定</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async updateFee() {
      // 发起修改用户信息的数据请求
        const { data: res } = await this.$http.post(
          "/users/effictiveusersupdatefee/?id=" + this.updateid,
          this.addFormFee
        );
        // 关闭对话框
        this.addDialogVisible = false;
