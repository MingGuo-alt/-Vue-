<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>会计</el-breadcrumb-item>
    </el-breadcrumb>
        ...
        <el-table-column label="操作">
          ...
          <template slot-scope="scope">
            ...
            <el-button
              ...
              icon="el-icon-delete"
              size="mini"
              @click="editAccountant(scope.row.id)"
            ></el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    async getUserList() {
      this.isQuery = false;
      const { data: res } = await this.$http.get("/users/accountant/", {
        params: {
          // sales_name: window.sessionStorage.getItem("user_id"),
    ...
    editUserInfo() {
      this.$refs.editFormRef.validate(async (valid) => {
        ...
        // 发起修改用户信息的数据请求
        const { data: res } = await this.$http.post(
          "/users/accountant/update/?id=" + this.updateid,
          this.editForm
        );
        // 关闭对话框
