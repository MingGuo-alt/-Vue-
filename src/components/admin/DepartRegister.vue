  ...
  <div>
    ...
    <el-card style="margin-top: 10px">
      ...
      <el-table :data="userlist" border stripe class="user_message_table">
        ...
        <el-table-column label="所属战区" prop="war_zone_name"> </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="所属战区" prop="account">
...
export default {
  ...
  methods: {
    ...
    async getUserList() {
      this.isQuery = false;
      const { data: res } = await this.$http.get("/users/salesdepart/", {
        params: {
          // sales_name: window.sessionStorage.getItem("user_id"),
    ...
    async removeUserById(id) {
        // console.log(id)
        // var url = "http://528z5g9921.zicp.vip/users/accountant/" + id + "/";
        // console.log(url)
      // 弹框询问用户
      ...
      // console.log('确认了删除')
      const { data: res } = await this.$http.delete("/users/salesdepart/" + id + "/");
