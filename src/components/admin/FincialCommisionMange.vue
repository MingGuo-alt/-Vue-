<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>金融专员</el-breadcrumb-item>
    </el-breadcrumb>
        ...
        <el-table-column label="操作">
          ...
          <template slot-scope="scope">
            ...
            <el-button
              ...
              icon="el-icon-delete"
              size="mini"
              @click="editFinancial(scope.row.id)"
            ></el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  methods: {
    ...
    addUser() {
      this.$refs.addFormRef.validate(async (valid) => {
        ...
        const { data: res } = await this.$http.post(
          "/users/financialcommission/register/",
          this.addForm
        );
    ...
    editUserInfo() {
      this.$refs.editFormRef.validate(async (valid) => {
        ...
        // 发起修改用户信息的数据请求
        const { data: res } = await this.$http.post(
          "/users/financialcommission/update/?id=" + this.updateid,
          this.editForm
        );
        // 关闭对话框
