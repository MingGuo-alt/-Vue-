<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>销售总监</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    >
      ...
      >
        ...
        <el-form-item label="所属战区" prop="war_zone">
          <el-input v-model="addForm.war_zone"></el-input>
        </el-form-item>
      </el-form>
      <!-- 底部区域 -->
...
export default {
  ...
  methods: {
    ...
    async getUserList() {
      this.isQuery = false;
      const { data: res } = await this.$http.get("/users/salesdirector/", {
        params: {
    ...
    async removeUserById(id) {
      ...
      // console.log('确认了删除')
      const { data: res } = await this.$http.delete("users/salesdirector/" + id + "/");
