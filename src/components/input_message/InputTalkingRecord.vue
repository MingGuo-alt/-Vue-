  ...
  <div>
    ...
    <el-card style="margin-top: 10px">
      ...
      <el-table :data="userlist" border stripe class="user_message_table">
        ...
        <el-table-column label="贷款金额" prop="loan_money"> </el-table-column>
        <el-table-column label="洽谈内容" prop="Conversation_record">
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    async getUserList() {
      this.isQuery = false;
      const { data: res } = await this.$http.get("/users/userconversation/", {
        params: {
