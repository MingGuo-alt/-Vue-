              ...
              <el-tabs v-model="activeSales" @tab-click="handleClick">
                ...
                >
                  ...
                  >
                    ...
                    <el-table-column label="打电话数" prop="tel_count">
                    </el-table-column>
                    <el-table-column label="有效电话数" prop="effective_tel_count"> </el-table-column>
                    <el-table-column label="意向客户数" prop="purpose_customer"> </el-table-column>
                    <el-table-column label="约谈客户数" prop="interview_customer">
                    </el-table-column>
                  </el-table>
                </el-tab-pane>
              </el-tabs>
